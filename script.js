...
xhr.open("GET", "https://denis-942a.restdb.io/rest/product");
xhr.setRequestHeader("content-type", "application/json");
xhr.setRequestHeader("x-apikey", "63a98574f43a573dae095745");
...
xhr.onload = function () {
    ...
    for (const product of products) {
        ...
        productElement.innerHTML = `
            ...
            <a href="user.html?id=${product.author_id}" id="seller">Seller profile</a>
            <button onclick="addProductToCart(${product.id})" id="buy">Buy</button>
        `
...
orderForm.addEventListener("submit", function (event) {
    ...
    let xhr = new XMLHttpRequest();
    xhr.open("POST", "https://denis-942a.restdb.io/rest/order");
    xhr.setRequestHeader("content-type", "application/json");
    xhr.setRequestHeader("x-apikey", "63a98574f43a573dae095745");
    xhr.setRequestHeader("cache-control", "no-cache");
    xhr.send(data);
